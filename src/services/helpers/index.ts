...
import { applyAmount, countActiveCategories, createCategory, getCategoryById, renameCategory, updateCategoryBudget } from "../categoryService.js";
...
export const submitEmail = async (email: string, user: UserDocument): Promise<{ ok: boolean; error?: string }>  => {
