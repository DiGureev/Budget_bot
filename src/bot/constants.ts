...
export const CREATE_CATEGORY_WARNING = 'Please create categories to track your spending first.';

export const CATEGORIES_LIMIT_REACHED_ERROR = 'You can add up to 8 categories.';

export const ENTER_CATEGORY_NAME_MESSAGE = 'Enter a name for your new category. You can include emojis. You will be able to edit it later.';

export const CATEGORY_NAME_EXISTS_ERROR = 'A category with this name already exists. Please choose another name.';

export const CREATE_CATEGORY_ERROR = 'Could not create the category. Please try again.';
...
export const CATEGORY_CONFIRMATION_MESSAGE = (type: CategoryType, categoryName: string) =>
  `You chose the ${type} type for "${categoryName}". Confirm?`;

export const CATEGORY_CONFIRM_WARNING = 'Please choose Yes or No using the buttons below.';

export const CATEGORY_TYPE_WARNING = 'Please confirm the category type using the buttons above.';

export const CATEGORY_BUDGET_SET_MESSAGE = (type: CategoryType, categoryName: string) =>
  `What budget would you like to set for the ${type} category "${categoryName}"?`;

export const CATEGORY_BUDGET_VALIDATION_ERROR = 'Please enter a valid positive budget.';
...
export const MAKE_DEFAULT_CATEGORY_MESSAGE = (categoryName: string, amount: string): string =>
...
export const SET_DEFAULT_ERROR = 'Only monthly categories can be set as default.';
...
export const CHOOSE_CATEGORY_TYPE_MESSAGE =
